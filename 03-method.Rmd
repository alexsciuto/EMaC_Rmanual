...
mydata %>% ggplot(aes(x = Freq_T)) + # this defines the x and y axes of the plot
  geom_histogram() + # this adds geometric objects
  theme_classic() + # this sets the theme for the plot
  theme_update(plot.title = element_text(hjust = 0.5)) + # this line centers the title
  xlab("Word Frequency of Target Word") + # this line sets the label for x-axis
  ylab("Count") + # this line sets the label for y-axis
  ggtitle("Word Frequency Distribution for Target Words") # this sets the title for the plot
