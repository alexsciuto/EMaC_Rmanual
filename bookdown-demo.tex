...
We will now be wrangling this new dataset we imported into R using several \texttt{dplyr} functions. These are the ones we will be covering. In the following sections I will explain what each functions does in detial.
...
\includegraphics{https://raw.githubusercontent.com/USF-Psych-DataSci/Classroom/master/img/pipe_routine.jpg}
